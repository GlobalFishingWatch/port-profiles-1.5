...
dak_voyages <- dplyr::select(tem_voyages, vessel_name=shipname, MMSI=ssvid,
...
```{r voyages extra as queries can't link up, echo=F, warning=F, include=FALSE}
...
write.csv(dplyr::select(full_dak_info,-vessel_id, -trip_id), here::here("data", "dakar_Q1_2024_19Apr2024.csv"), row.names=F)
```
