...
start_date <- "'2024-04-01 00:00:00 UTC'" 
end_date <- "'2024-06-30 23:59:59 UTC'"
year <- 2024
country_iso3 <- "'SEN'"
port_name <- "'DAKAR'"
...
#write.csv(dplyr::select(full_dak_info,-vessel_id, -trip_id), here::here("data", "dakar_Q2_2024_16Jul2024.csv"), row.names=F)
```
