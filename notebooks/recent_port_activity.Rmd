...
```{r voyages ais, echo=F, warning=F, include=FALSE}
...
dak_voyages <- dplyr::select(voyages, vessel_name=shipname, MMSI=ssvid,
   ...
   previous_port = start_port_label, trip_start, trip_end, trip_duration_days,
   end_port = end_port_label, fishing=num_fishing, fishing_hours, fishing_eez=eezs, fishing_hs =high_seas, fishing_rfmo = rfmos, encounter= num_encounters, num_encounters, loitering=num_loitering, num_loitering, gaps=num_gaps, num_gaps, total_gap_hours)
