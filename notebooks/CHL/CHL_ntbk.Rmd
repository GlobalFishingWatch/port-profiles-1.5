...
CHL_ports_2015_25 <- fishwatchr::gfw_query(query = here::here("queries", "CHL", "CHL_voyages_query.sql"), run_query = TRUE, con = con)$data

# set df to use in figures
visits_df <- CHL_ports_2015_25 %>% filter(year > 2015)
