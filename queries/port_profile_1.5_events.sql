...
CREATE TABLE `world-fishing-827.scratch_joef.events_conakry_2020-22_pipe25` AS
...
encounter_v_info AS(
  ...
  FROM(
    ...
    LEFT JOIN (
      ...
      FROM
        `pipe_production_v20201001.all_vessels_byyear_v2_v20231201`) vi -- update to pipe3
      ON
