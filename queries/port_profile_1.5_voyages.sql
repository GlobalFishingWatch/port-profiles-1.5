...
-- CREATE TABLE `world-fishing-827.scratch_joef.voyages_conakry_2020-22` AS
...
--------------------------------------
  add_vessel_info AS (
    ...
    JOIN (
      ...
      FROM
        `pipe_production_v20201001.all_vessels_byyear_v2_v20231201`) -- update to latest v
      USING
        (vessel_id, year))

--------------------------------------
-- pull just vessel list entering POI
