...
RETURNS ARRAY<STRING> AS (
    [{port_labels}]
--  [ "SUBIC", "SUBIC BAY VICINITY", "SEATRIAL", "PH SUBIC",
--    "W IN SUBIC BAY ONLY", "NAVOTAS", "MANILA", "NIUGAN",
--    "GENERAL SANTOS", "DAVAO", "TORIL" ]
);
--CREATE TEMP FUNCTION port_iso() AS (CAST("PHL" AS STRING));
CREATE TEMP FUNCTION port_iso() AS ({port_iso});


-- create temp table
CREATE TABLE `world-fishing-827.scratch_max.phl_nondes_voyages_temp`
OPTIONS (
