-- 31/01/2025 combined voyage, events, ais coverage
...
add_port_events AS(
  ...
  LEFT JOIN (
    SELECT
      ...
      anchorage_id AS port_event_anchorage_id,
  ...
  FROM (
    ...
    LEFT JOIN (
      SELECT
        ...
        distance_from_shore_m AS port_distance_from_shore_m,
        dock AS at_dock
      FROM `anchorages.named_anchorages_v20240117`) as b
    ON a.port_event_anchorage_id = b.s2id) as c
  ),
...
events AS (
  SELECT
    ...
    a.year,
      ...
      b.end_port_label,
      -- b.end_port_sublabel,
      b.trip_end_anchorage_id AS port_anchorage_id,
      b.total_voyage_days,
      b.total_voyage_h,
      b.total_ais_h,
      b.percent_ais_voyage,
    ...
    CAST(NULL AS string) AS port_event_anchorage_id,
...
combined AS(
  SELECT
    ...
    end_port_iso3,
    end_port_label,
    trip_end_anchorage_id AS port_anchorage_id,
    total_voyage_days,
    total_voyage_h,
    total_ais_h,
    percent_ais_voyage,
...
id_spoofers AS(
  SELECT ssvid
  FROM `world-fishing-827.gfw_research.vi_ssvid_byyear_v20241101`
  WHERE
