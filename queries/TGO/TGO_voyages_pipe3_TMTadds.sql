--------------------------------------
  -- Query to quantify foreign fishing and carrier vessel visits and unique vessels visiting Lome, Togo.
  --
...
CREATE TABLE `world-fishing-827.PortsProgramme.TGO_voyages_2021-23` AS
   ...
   SELECT DISTINCT
    ...
    WHERE
     ...
     AND ssvid IN ("200000001", "657215900", "708500000", "377877000", "412000002",
                    ...
                    "671070300", "671233100", "725001553", "799180816") -- add additional vessels here
    ),
...
--------------------------------------
  ...
  # filter for ports of interest -- using anchorages list for Monrovia in this case
      OR ssvid IN ("200000001", "657215900", "708500000", "377877000", "412000002",
                    "627000000", "671032300", "671033300", "627000029", "671046300",
                    "671070300", "671233100", "725001553", "799180816") -- adding in TMT missing vessels
...
-- pull_by_anchorage AS(
  ...
  LEFT JOIN (
    SELECT
      ...
      port_or_anchorage,
      GhanaEEZ as anch_in_ghanaEEZ
    FROM `PortsProgramme.TGO_anchorages_TMTreviewed`)
